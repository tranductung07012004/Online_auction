...
import com.service.auction.repository.BidRequestRepository;
import com.service.auction.repository.ProductRepositoryInAuction;
...
public class BidRequestServiceImpl implements BidRequestService {
    ...
    public BidRequestResponse verifyBidRequest(Long bidderId, Long productId, Long sellerId) {
        ...
        ProductInAuction product = productRepository.findById(productId)
