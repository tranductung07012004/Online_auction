package com.service.auction.entity;
...
public class ProductInAuction {
    ...
    @Builder.Default
    private List<ProductDescriptionInAuction> descriptions = new ArrayList<>();

    @OneToMany(mappedBy = "product", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    @Builder.Default
    private List<ProductPictureInAuction> pictures = new ArrayList<>();
    ...
    @Builder.Default
    private List<ProductCategoryInAuction> productCategories = new ArrayList<>();
