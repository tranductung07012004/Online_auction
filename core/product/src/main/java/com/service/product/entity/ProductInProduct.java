...
public class ProductInProduct {
    ...
    @Builder.Default
    private List<ProductDescriptionInProduct> descriptions = new ArrayList<>();

    @OneToMany(mappedBy = "product", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    @Builder.Default
    private List<ProductPictureInProduct> pictures = new ArrayList<>();
    ...
    @Builder.Default
    private List<ProductCategoryInProduct> productCategories = new ArrayList<>();
