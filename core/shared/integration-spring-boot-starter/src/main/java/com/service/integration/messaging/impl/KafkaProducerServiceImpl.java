package com.service.integration.messaging.impl;

import com.service.common.dto.KafkaMessage;
...
public class KafkaProducerServiceImpl implements KafkaProducerService {
    ...
    public KafkaProducerServiceImpl(KafkaTemplate<String, Object> kTemplate) {
        this.kafkaTemplate = kTemplate;
    }
    ...
    public void sendMessageWithCallback(String topic, String eventType, Object payload) {
        ...
        future.whenComplete((result, ex) -> {
            if (ex == null) {
                ...
                // Dead letter queue execution here maybe
    ...
    @Override
    public void sendMessageWithKeyAndCallback(String topic, String key, String eventType, Object payload) {
        KafkaMessage message = KafkaMessage.builder()
                .messageId(UUID.randomUUID().toString())
                .eventType(eventType)
                .payload(payload)
