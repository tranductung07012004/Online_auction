...
public class ProductInAdmin {
    ...
    @Builder.Default
    private List<ProductDescriptionInAdmin> descriptions = new ArrayList<>();

    @OneToMany(mappedBy = "product", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    @Builder.Default
    private List<ProductPictureInAdmin> pictures = new ArrayList<>();
    ...
    @Builder.Default
    private List<ProductCategoryInAdmin> productCategories = new ArrayList<>();
